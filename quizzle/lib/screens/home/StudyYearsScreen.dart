...
import 'ContantScreen.dart';

class StudyYearsScreen extends StatelessWidget {
  static const String routeName = '/study_years';

  const StudyYearsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final StudyYearsController controller = Get.put(StudyYearsController());
  ...
  //     StudyYearsController controller, String type, String label) {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        ...
        Get.toNamed(ContentScreen.routeName, arguments: subject);
      },
      child: Container(
